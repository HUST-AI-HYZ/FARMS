        ...
        if isinstance(m, nn.Conv2d) or isinstance(m, nn.Linear):
            ...
            if fix_fingers == 'xmin_mid':
                ...
                if fix_fingers == 'xmin_peak':
                    ...
                    ####if min_e or max_e is finite
                    if torch.isinf(min_e) and min_e < 0:
                        min_e = -100        
                    elif torch.isinf(max_e) and max_e > 0:
                        max_e = 100     
            ...
            results['esd_time_cost'].append(end_time - start_time)
            print(f"Layer: {name}, Number of eigs: {len(eigs)}, Time Cost: {end_time - start_time}")
